...
**真双语写法**：同一条目里 `问：`+`Q:` 成对、`答：`+`A:` 成对（顺序任意，第二语言问题紧跟在答案出现之前即可归入同条目）：

```text
★问：你们的营业时间是几点到几点？
Q: What are your opening hours?
答：每天上午11:00至晚上22:00营业。
A: Open daily 11:00-22:00.
```

只写一种语言也完全可以（缺的语言自动镜像，界面语言切换钮仍在）。示例见 `examples/input_restaurant.txt`（16 条全双语）。
